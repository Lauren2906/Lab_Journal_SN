...
```
Because I cannot figure out how to load the data into R, I did it manually, but that means that it won't run when I try to build it, so I deleted all the "```" from the chuncks underneath, in order to still be able to upload my work. It doesn't look that pretty though.
<br>

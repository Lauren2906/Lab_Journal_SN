...
# Working in class
Retrying a network analysis, but with trying different things, than just copying the website
...
Load data
```{r}
#df_ind <- load(".data/All-ListedData_MRCP_Wave12_Ind.RData")
#df_network <- load(".data/All-ListedData_MRCP_Wave12_Net.RData")
